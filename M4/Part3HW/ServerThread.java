...
public class ServerThread extends Thread {
     ...
     */
    protected boolean sendToClient(String message) { //boolean to determine is send is successful w/o exception
        if (!isRunning) {
            return false;
        }
        try {
    ...
    @Override // override because run comes from thread class
    public void run() {
